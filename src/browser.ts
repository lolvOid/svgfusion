...
import { SVGFusion, SVGFusionOptions, ConversionResult } from './engine';
import { ReactGeneratorOptions } from './generators/react';
import { VueGeneratorOptions } from './generators/vue';
...
export class SVGFusionBrowser {
  ...
  async convert(
    ...
    const result = await this.engine.convert(svgContent, fusionOptions);
