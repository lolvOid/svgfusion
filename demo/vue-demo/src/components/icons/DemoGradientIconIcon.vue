...
<script setup lang="ts">
  ...
  const props = withDefaults(defineProps<Props>(), {
    ...
    color6: '#49BBD7',
    color6Class: undefined,
    color7: '#57B5D9',
    color7Class: undefined,
    color8: '#63AFDB',
    color8Class: undefined,
