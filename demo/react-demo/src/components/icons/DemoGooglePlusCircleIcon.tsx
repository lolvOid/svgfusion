...
interface DemoGooglePlusCircleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
  titleId?: string;
  desc?: string;
  descId?: string;
...
const DemoGooglePlusCircleIcon = (
  {
    title,
    titleId,
    desc,
...
const ForwardRef = forwardRef(DemoGooglePlusCircleIcon);
